...
export const servicesReducer = (state=initialState,action) => {
	switch (action.type) {
		...
		return {
			...state, dataServices: action.dataServices,loading: false, hasErrored: false, message: 'ok',  id:'',	formData: ''
		}
		...
		return {
			...state, dataServices: '' ,loading: false, hasErrored: false, message: 'notFound',  id:'',	formData: ''
		}
